                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <!-- Gender -->
                            <div class="form-floating mb-3">
                                <select type="select" class="form-select @error('gender') is-invalid @enderror" id="floatingSelect" aria-label="Floating label select example" name="gender" value="{{ Auth::user()->gender }}" required autocomplete="gender" autofocus>
                            ...
                            <!-- NIC -->
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control @error('nic') is-invalid @enderror" id="floatingText" name="nic" value="{{ Auth::user()->nic }}" required autocomplete="nic" placeholder="******V" autofocus>
                            ...
                            <!-- Date Of Birth -->
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control @error('dateOfBirth') is-invalid @enderror" id="floatingText" name="dob" value="{{ Auth::user()->dob }}" required autocomplete="dob" autofocus>
                        ...
                        <div class="col-6">
                            ...
                            <!-- Email -->
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="floatingText" name="email" value="{{ Auth::user()->email }}" required autocomplete="email" autofocus placeholder="name@example.com">
                            ...
                            <!-- Address -->
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control @error('address') is-invalid @enderror" id="floatingText" name="address" value="{{ Auth::user()->address }}" required autocomplete="address" autofocus placeholder="name@example.com">
                            ...
                            <!-- Phone Number -->
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control @error('contact_no') is-invalid @enderror" id="floatingText" name="contactNo" value="{{ Auth::user()->contactNo }}" required autocomplete="contactNo" autofocus placeholder="XXXXXXXXXX">
