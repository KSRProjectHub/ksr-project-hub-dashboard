...
<!-- CSRF Token -->
    ...
    <link rel="stylesheet" href="{{asset('fronte/css/style.css')}}" />
    <!-- Favicon -->
...
<!-- End Google Tag Manager (noscript) -->
                ...
                <ul>
                    <li>
                        <a href="https://facebook.com">
                            <img src="{{asset('fronte/images/facebook.png')}}" target="_blank" alt="" />
                        </a>
                    </li>
                    <li>
                        <a href="https://twitter.com">
                            <img src="{{asset('fronte/images/twitter.png')}}" target="_blank" alt="" />
                        </a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/ksrprojecthub/">
                            <img src="{{asset('fronte/images/instagram.png')}}" target="_blank" alt="link_to_instagram" />
                        </a>
                    </li>
                </ul>
                <a href="mailto:you@email.com" class="email-icon">
                    <img src="{{asset('fronte/images/email.png')}}" alt="" />
                </a>
            </div>
        </div>
    </header>
    ...
    <script src="{{asset('fronte/js/script.js')}}"></script>
    <!-- GetButton.io widget -->
    <script type="text/javascript">
        (function () {
            var options = {
