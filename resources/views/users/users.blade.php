                        ...
                        @else
                            @foreach ($uTypes as $item)
                                <tr>
                                    <td>{{ $item->userType }}</td>
                                    <td>
                                        <a href="users/edit-userType/{{ $item->id }}" type="button" class="btn btn-primary"><i class="fa-solid fa-pen"></i></a>
                                        <a href="deleteUserType/{{ $item->id }}" type="button" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
                    ...
                    @else
                        @foreach ($user as $item)
                            <tr>
                                ...
                                <td>{{$item->userType }}</td>
                                <td>
                                    <a href="users/editUser/{{ $item->id }}" type="button" class="btn btn-primary"><i class="fa-solid fa-pen"></i></a>
                                    <a href="deleteUser/{{ $item->id }}" type="button" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    @endif
