                                        ...
                                        <div class="profile-widget">
                                            <div class="profile-img mb-3">
                                                ...
                                                <?php if($item->profileimage == null): ?>
                                                    ...
                                                    <?php endif; ?>                                                    
                                                <?php else: ?>
                                                    <img class="rounded-circle" src=" <?php echo e(asset('img/user-images/' . $item->profileimage  )); ?>" alt="" style="width: 80px; height: 80px;">
                                                <?php endif; ?>
...
<?php echo $__env->make('layouts.adminApp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\supun\Documents\ksr-project-hub-dashboard\resources\views/users/users.blade.php ENDPATH**/ ?>