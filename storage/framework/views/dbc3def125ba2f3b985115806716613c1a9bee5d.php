        ...
        <div class="row g-4 border px-2 w-100 rounded">
            ...
            <div class="row mb-3 justify-content-start">
                <div class="btn-group w-50" role="group">
                    <a href="<?php echo e(route('admin.users')); ?>" type="button" class="btn btn-outline-primary col-4"><i class="fa fa-home me-2"></i>Icon Left</a>
                    <a href="<?php echo e(route('admin.usersGrid')); ?>" type="button" class="btn btn-outline-primary col-4 <?php echo e((request()->is('admin/usersGrid')) ? 'active' : ''); ?>">Icon Left<i class="fa fa-home ms-2"></i></a>                    
                </div>
