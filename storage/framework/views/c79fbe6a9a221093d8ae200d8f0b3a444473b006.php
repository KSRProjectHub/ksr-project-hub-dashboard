    ...
    <div class="row">
        <div class="col-4">
            <div class="bg-light rounded h-100 p-4">
                ...
                <div class="mb-3">
                    <p><?php echo e(date_format($user->created_at,'d M Y')); ?></p>
                    <p><?php echo e(date_format($user->updated_at,'d M Y')); ?></p>
                </div>
            </div>
        </div>
        <div class="col-8">
...
unset($__errorArgs, $__bag); ?>" id="floatingSelect" aria-label="Floating label select example" name="gender" value="<?php echo e($user->gender); ?>" required autocomplete="gender" autofocus>
                                    ...
                                    <option value="<?php echo e($user->gender); ?>" selected>
...
unset($__errorArgs, $__bag); ?>" id="floatingText" name="nic" value="<?php echo e($user->nic); ?>" required autocomplete="nic" placeholder="******V" autofocus>
...
unset($__errorArgs, $__bag); ?>" id="floatingText" name="address" value="<?php echo e($user->address); ?>" required autocomplete="address" autofocus placeholder="name@example.com">
...
unset($__errorArgs, $__bag); ?>" id="floatingText" name="contactNo" value="<?php echo e($user->contactNo); ?>" required autocomplete="contactNo" autofocus placeholder="XXXXXXXXXX">
